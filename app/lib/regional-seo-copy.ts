...
const SERVICE_DATA: Record<string, ServiceSeoData> = {
  ...
  restoration:
    "네일샵 퇴점 원상복구는 간판과 시트지 제거, 선반 고정 자국, 벽면 타공, 바닥 접착제 흔적까지 임대차 반환 기준에 맞춰 확인합니다.",
  estimate:
    "견적은 매장 면적뿐 아니라 붙박이 가구 수량, 간판 철거 여부, 바닥재 제거 범위와 폐기물 반출량을 함께 확인해 산정합니다.",
  caution:
    "소형 네일샵도 철거 범위가 명확하지 않으면 불필요한 공사가 생길 수 있어 임대인과 원상복구 기준을 먼저 확인하는 것이 좋습니다.",
  cta:
    "매장 내부와 간판, 바닥 사진을 보내주시면 퇴점 시 필요한 네일샵 철거·원상복구 범위를 확인해드립니다.",
  faq: [
    {
      question: "폐업하면서 간판과 시트지도 함께 철거할 수 있나요?",
      answer:
        "간판 설치 방식과 유리 시트지 상태를 확인해 철거 범위와 마감 방법을 안내합니다.",
    },
    {
      question: "임대인이 요구하는 원상복구 범위도 확인해주나요?",
      answer:
        "임대차 계약 내용과 현장 상태를 기준으로 철거가 필요한 부분과 남길 부분을 구분해 상담합니다.",
    },
    {
      question: "바닥재를 모두 철거해야 하나요?",
      answer:
        "기존 바닥 상태와 임대인 반환 기준에 따라 전체 철거 또는 부분 정리 여부를 판단합니다.",
    },
    {
      question: "영업 종료일에 맞춰 철거 일정을 잡을 수 있나요?",
      answer:
        "퇴점일과 임대차 반환 일정을 확인한 뒤 가능한 작업 일정과 공정 순서를 조율합니다.",
    },
  ],
},
